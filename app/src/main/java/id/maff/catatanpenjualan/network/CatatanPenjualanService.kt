package id.maff.catatanpenjualan.network

import id.maff.catatanpenjualan.activity.data_barang.data.ResultDataBarang
import id.maff.catatanpenjualan.activity.login.data.ResultLogin
import id.maff.catatanpenjualan.activity.penjualan.data.ResultKeranjang
import id.maff.catatanpenjualan.activity.penjualan.data.ResultSearchBarang
//import id.maff.catatanpenjualan.activity.report.detail.data.ResultItemKeranjang
import id.maff.catatanpenjualan.response.ResultSimple
