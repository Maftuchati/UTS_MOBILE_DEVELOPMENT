package id.maff.catatanpenjualan.activity._main
...
import id.maff.catatanpenjualan.R
import id.maff.catatanpenjualan.activity._main.adapter.MenuAdapter
import id.maff.catatanpenjualan.activity._main.presenter.MainPresenter
import id.maff.catatanpenjualan.activity._main.presenter.MainView
import id.maff.catatanpenjualan.activity.data_barang.DataBarangActivity
import id.maff.catatanpenjualan.activity.login.LoginActivity
import id.maff.catatanpenjualan.activity.penjualan.PenjualanBarang
import id.maff.catatanpenjualan.activity.report.ReportActivity
import id.maff.catatanpenjualan.base.BaseActivity
import id.maff.catatanpenjualan.model.Keranjang
import id.maff.catatanpenjualan.utils.Uang
